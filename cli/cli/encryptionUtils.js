...
export async function encryptContent(content, recipientName = null, usePgp = false) {
    try {
        let publicKey;
        let recipientInfo;
...
// Decrypt content
export async function decryptContent(encryptedBuffer, pgpPrivateKeyPath = null, pgpPassphrase = null, useGpgKeyring = true) {
    try {
